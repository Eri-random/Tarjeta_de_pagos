...
formulario.inputNumero.addEventListener('keyup', (e) =>{
 ...
 if(valorInput[0] == 4){
   logoMarca.innerHTML= '';
   tarjetaDelantera.style.backgroundImage="url(img/bg-tarjeta/bg-tarjeta-visa.jpg)"
   tarjetaTrasera.style.backgroundImage="url(img/bg-tarjeta/bg-tarjeta-visa.jpg)"
   ...
   for (var i = 0; i < grupos.length; i++) {
     ...
     grupos[i].classList.add('visa-color');
      ...
      tarjetaDelantera.style.backgroundImage = "url(img/bg-tarjeta/bg-mastercard.jpg)";
      tarjetaTrasera.style.backgroundImage = "url(img/bg-tarjeta/bg-mastercard.jpg)";
